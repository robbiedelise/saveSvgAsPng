...
- `styleSheets` - Array of `CSSStyleSheet` objects to override `document.Stylesheets`. Can be used to filter stylesheets from `document.Stylesheets` beforehand or generate your own `CSSStyleSheet`.
